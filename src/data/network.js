...
const network = {
  ...
  aboutMe: (
    <p>
      ...
      maintaining the critical infrastructure that keeps enterprise systems
      securely connected. My journey into networking started with a natural
      curiosity for how data moves, leading me from managing the physical
      hardware of a Tier IV data center to configuring the logical routes that
      connect it all. Today, I leverage my hands-on experience with Cisco and
      Arista hardware, alongside my CompTIA Network+ certification, to
      troubleshoot complex connectivity issues and deploy secure VPNs. When I’m
      away from the command line, you can usually find me getting a workout in,
      watching a boxing match, catching up on Star Wars lore, or playing video
      games. I’m a lifelong learner, always tinkering with the DNS and network
      security of my homelab, and looking for the next infrastructure challenge
      to solve.
    </p>
  ),
  ...
  skills: [
    ...
    },
    {
      ...
      header: 'Containers & Automation',
      list: ['Docker', 'Infrastructure Automation, Cron']
    },
    {
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
